...
export const getDifficultyInfo = (level: number): DifficultyInfo => {
  switch (level) {
    ...
    case 3:
      return { label: '中级', color: '#00838f', bgColor: '#e0f7fa' }; // Cyan/Teal
    case 4:
      return { label: '高级', color: '#ef6c00', bgColor: '#fff3e0' };   // Orange
    case 5:
      return { label: '专家级', color: '#c62828', bgColor: '#ffebee' };   // Red
    default:
